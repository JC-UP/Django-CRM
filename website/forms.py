...
class AddRecordForm(forms.ModelForm):
	...
	Booktype = forms.CharField (required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Booktype", "class":"form-control"}), label="")
	Chapters = forms.CharField (required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Chapters", "class":"form-control"}), label="")
